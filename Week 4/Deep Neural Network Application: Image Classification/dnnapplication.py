...
def two_layer_model(X, Y, layers_dims, learning_rate=0.0075, num_iterations=1, print_cost=False):
    np.random.seed(1)
    grads = {}
...
### CONSTANTS ###
layers_dims = [4, 5, 2, 1]  # 5-layer model
...
parameters = L_layer_model(train_data_x, train_output_y, layers_dims,learning_rate=0.0001, num_iterations=20000, print_cost=True)
pred_train = predict(train_data_x, train_output_y, parameters)
